...
=======
      title: '💡 Ayuda - Piloto HUMANBIBLIO',
      subtitle: 'Estamos en fase de prueba piloto',
      sections: [
        {
          title: '¿Qué es el piloto?',
          content: 'Estás probando la versión piloto de HUMANBIBLIO. Tu feedback es crucial para mejorar la plataforma antes del lanzamiento oficial.'
        },
        {
          title: '🏛️ El Ágora',
          content: 'Conecta con profesionales y mentes brillantes. Usa el buscador para encontrar personas por profesión, intereses o ubicación. Puedes iniciar conversaciones, llamadas o videollamadas.'
        },
        {
          title: '🛍️ World Boulevard',
          content: 'Descubre negocios locales únicos. Los usuarios con el botón verde "WB Vende" tienen perfil comercial. Click en ese botón para ver sus productos/servicios.'
        },
        {
          title: '📊 Dashboard',
          content: 'Tu centro de control con estadísticas, explorador de personas/negocios cercanos y matching con IA. Las funcionalidades "Coming Soon" estarán disponibles próximamente.'
        },
        {
          title: '🆕 Funcionalidades Coming Soon',
          content: 'Indica tu interés en las funcionalidades futuras (llamadas, traducción en tiempo real, CRM, crowdfunding). Tu voto ayuda a priorizar el desarrollo.'
        },
        {
          title: '❓ ¿Necesitas ayuda?',
          content: 'Contáctanos por email: support@humanbiblio.com o usa el formulario de feedback en las tarjetas "Coming Soon".'
        }
      ]
    },
    en: {
      title: '💡 Help - HUMANBIBLIO Pilot',
      subtitle: 'We are in pilot testing phase',
      sections: [
        {
          title: 'What is the pilot?',
          content: 'You are testing the pilot version of HUMANBIBLIO. Your feedback is crucial to improve the platform before the official launch.'
        },
        {
          title: '🏛️ The Agora',
          content: 'Connect with professionals and brilliant minds. Use the search bar to find people by profession, interests, or location. You can start conversations, calls, or video calls.'
        },
        {
          title: '🛍️ World Boulevard',
          content: 'Discover unique local businesses. Users with the green "WB Sells" button have a business profile. Click that button to see their products/services.'
        },
        {
          title: '📊 Dashboard',
          content: 'Your control center with statistics, nearby people/businesses explorer, and AI matching. "Coming Soon" features will be available soon.'
        },
        {
          title: '🆕 Coming Soon Features',
          content: 'Show your interest in future features (calls, real-time translation, CRM, crowdfunding). Your vote helps prioritize development.'
        },
        {
          title: '❓ Need help?',
          content: 'Contact us by email: support@humanbiblio.com or use the feedback form on the "Coming Soon" cards.'
        }
      ]
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
    }
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-2">
                    {language === 'es' ? '¡Gracias por participar!' : 'Thank you for participating!'}
                  </h4>
                  <p className="text-gray-700">
                    {language === 'es'
                      ? 'Tu participación en el piloto es invaluable. Cada interacción, cada feedback, cada sugerencia nos ayuda a construir una plataforma mejor para todos.'
                      : 'Your participation in the pilot is invaluable. Every interaction, every feedback, every suggestion helps us build a better platform for everyone.'}
                  </p>
                </div>
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
              </div>
