...
=======
          Sé el Primer Financiador Destacado
        </h3>
        <p className="text-yellow-700 mb-4">
          Financia proyectos innovadores y aparece en este carrusel premium
        </p>
        <button
          onClick={() => alert('🚀 Ve a "No estás solo en el Universo" para financiar proyectos y aparecer aquí')}
          className="px-6 py-3 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-xl hover:from-yellow-700 hover:to-orange-700 transition-all duration-300 font-semibold"
        >
          🌟 Convertirme en Financiador
...
=======
                          <span className="text-gray-500 text-sm">financiados</span>
                        </div>
                      </div>
                      ...
                      <p className="text-gray-600 leading-relaxed mb-6">
                        {sponsor.public_message || `${sponsor.funder_name} es un financiador activo que apoya proyectos innovadores en HUMANBIBLIO.`}
                      </p>

                      <div className="space-y-2 mb-6">
                        <h4 className="font-semibold text-gray-900">Impacto como financiador:</h4>
                        <div className="flex flex-wrap gap-2">
                          <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">
                            {Math.floor(Math.random() * 5) + 1} proyectos financiados
                          </span>
                          <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">
                            {Math.floor(Math.random() * 20) + 10} emprendedores apoyados
                          </span>
                          <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm">
                            ${(sponsor.amount_funded * (Math.random() * 3 + 1)).toLocaleString()} impacto total
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
                          </span>
                        </div>
                      </div>
...
=======
                        {sponsor.is_wb_business ? '🛍️ Ver Negocio en Boulevard' : '👤 Ver Perfil en Ágora'}
                      </button>
                      
                      <div className="grid grid-cols-2 gap-3">
                        <button
                          onClick={() => alert(`💬 Iniciando conversación con ${sponsor.funder_name}...`)}
                          className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
                        >
                          💬 Contactar
                        </button>
                        <button
                          onClick={() => alert(`🤝 Explorando colaboraciones con ${sponsor.funder_name}...`)}
...
=======
            <span className="text-sm font-medium text-gray-700">Financiadores Destacados</span>
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
          </div>
...
=======
            <span className="text-sm font-medium text-gray-700">Inversión Inteligente</span>
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
          </div>
          <div className="w-px h-4 bg-gray-300"></div>
          <div className="flex items-center space-x-2">
...
=======
            <span className="text-sm font-medium text-gray-700">Reconocimiento Premium</span>
>>>>>>> d2f4627176dbd2b45f9f32eb8f6c4ad1770ae193
          </div>
        </div>
      </div>
